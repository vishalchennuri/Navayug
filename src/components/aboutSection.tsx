...
export default function AboutUsSection() {
  return (
    <section className="px-6 md:px-10 lg:px-16 py-10 md:py-20">
      <div className="flex flex-col md:flex-row gap-12 items-center md:items-start max-w-7xl mx-auto">
        
        {/* Left Column (Heading + Image on desktop) */}
        <div className="w-full md:w-[35%] flex flex-col md:items-start md:text-left">
          <SectionHeader title="ABOUT US" />
          
          {/* First Paragraph shown below header on mobile */}
          <p className="block md:hidden mt-6 text-2xl font-text font-medium text-[var(--color-dark)] leading-snug tracking-tight">
          ...
          {/* Image comes after paragraph on mobile */}
          <img
            src="/about.png"
            alt="About graphic"
            className="mt-6 w-2/3 md:w-[80%] max-w-[250px] h-auto object-contain mx-auto md:mx-0"
          />

          {/* Second paragraph below image on mobile */}
          <p className="block md:hidden mt-6 text-xl text-[var(--color-soft-gray)] leading-snug font-medium">
        ...
        {/* Right Column (Text only for desktop) */}
        <div className="hidden md:block w-full md:w-[65%]">
